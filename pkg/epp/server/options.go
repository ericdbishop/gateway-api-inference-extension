...
func (opts *Options) Validate() error {
	...
	if (opts.ConfigText == opts.ConfigFile) || (opts.ConfigText != "" && opts.ConfigFile != "") {
		return fmt.Errorf("exclusively one of %q or %q flags need to be set", "config-text", "config-file")
	}
